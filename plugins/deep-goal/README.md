...
- **Install (Claude Code):** `/plugin marketplace add reurgency/marketplace` → `/plugin install deep-goal@reurgency`. Other hosts: see `HOSTS.md` (Claude Code is the verified floor).
